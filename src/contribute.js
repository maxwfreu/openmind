        ...
        if(item.colSize ==="col-md-6 col-sm-6 col-xs-12"){
          return(
            <div className={item.colSize} key={i}>
              <NewsCardBig title={item.title} detail={item.detail} uniqueKey={item.uniqueKey} url={item.url} blurb={item.blurb} totalPoints={item.totalPoints}/>
            </div>
          )
        } else {
          return(
            <div className={item.colSize} key={i}>
              <NewsCard title={item.title} detail={item.detail} uniqueKey={item.uniqueKey} url={item.url} blurb={item.blurb} totalPoints={item.totalPoints}/>
            </div>
          )
        }
      }
