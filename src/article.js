      ...
      <div className="col-md-4">
        <div className="container-fluid">
          <div className="articleList">
            <SideInfo canEarn={article.canEarn} points={article.points} totalPoints={article.totalPoints} percent={article.percent} pointNum={article.pointNum}/>
            <SimilarArticles/>
